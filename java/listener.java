...
public class listener {
	...
	@Override
	    ...
	    this.count++;
	    System.out.println("[Java  Listener] Scope " + scope + ": received "
			       + this.count + "/" + this.expected + ": " + data);
	}
	...
	for (int size : sizes) {
		...
		try {
		    ...
		    subscriber.activate();
		    DataHandler<String> handler = new DataHandler<String>(scope, size, 1200);
		    ...
		    System.err.println("[Java Listener] Failure for size " + size + ": " + e);
		}
	    }
	}
    }
